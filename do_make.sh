...
FUSION_ACCESS_DEPS_ROOT="${FUSION_ACCESS_DEPS_ROOT:-/mnt/n0test/xinghui.shao/gds/FusionAccess/third_party/install}"
...
[[ -d "${FUSION_ACCESS_DEPS_ROOT}" ]] || die "FusionAccess deps root not found: ${FUSION_ACCESS_DEPS_ROOT}"
